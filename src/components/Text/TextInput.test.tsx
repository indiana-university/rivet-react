...
describe('<Input />', () => {
    describe("Rendering", () => {
        it('should render without throwing an error', () => {
            const cut = shallow(<TextInput label="Label" />);
    ...
    describe("Inline Alerts", () => {
        ...
        it('valid style', () => { 
            const cut = shallow(<TextInput valid note="Note" label="Label" />);
        ...
        it('warning style', () => { 
            const cut = shallow(<TextInput warning note="Note" label="Label" />);
        ...
        it('invalid style', () => { 
            const cut = shallow(<TextInput invalid note="Note" label="Label" />);
