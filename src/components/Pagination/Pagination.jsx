...
// export const Item = ({ ariaLabel, children, className, current, disabled = false, id = Rivet.shortuid(), onClick = (e) => { e.preventDefault(); }, ...attrs }) => {
//     if (disabled) {
//         return (
//             <li id={id} className={classNames(`rvt-pagination__item`, className)} aria-label={ariaLabel} {...attrs}>
//                 { children }
//             </li>
//         );
//     }
//     return (
//         <li id={id} className={classNames("rvt-pagination__item", className)} {...attrs}>
//             <a href="#0" onClick={onClick} aria-label={ariaLabel} aria-current={current && "page"}>
//                 { children }
//             </a>
//         </li>
//     );
