...
describe('<Input />', () => {
    describe("Rendering", () => {
        ...
        it('should associate the label with the input', () => {
            const cut = shallow(<Input id="the_id" label="Label" />);
            expect(cut.find('input').prop('id')).toEqual("the_id");
            expect(cut.find('label').prop('htmlFor')).toEqual("the_id");
        });
        it('should apply custom class', () => {
            const cut = shallow(<Input className="my-class" label="Label" />);
    ...
    describe("Inline Alerts", () => {
        it('info style', () => { 
            const cut = shallow(<Input info note="Note" label="Label" />);
        ...
        it('valid style', () => { 
            const cut = shallow(<Input valid note="Note" label="Label" />);
        ...
        it('warning style', () => { 
            const cut = shallow(<Input warning note="Note" label="Label" />);
        ...
        it('invalid style', () => { 
            const cut = shallow(<Input invalid note="Note" label="Label" />);
