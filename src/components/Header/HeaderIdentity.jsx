...
//     <div className="rvt-header-id__profile">{label}</div>
//     {logout}
//   </div>
// );
//
...
//       variant="navigation"
//       align="right"
//       className="rvt-header-id__profile rvt-header-id__profile--has-dropdown"
//       menuClass="rvt-header-id__menu"
//     >
//       {children}
//       {logout && <DropdownGroup>{logout}</DropdownGroup>}
//     </Dropdown>
//   </div>
// );
//
...
// );
//
// const HeaderIdentity: React.SFC<
//   HeaderIdentityProps & React.HTMLAttributes<HTMLDivElement>
// > = ({ avatar, children, className, logoutLinkText, onLogout, username }) => {
...
//     <span className="rvt-header-id__avatar" aria-hidden="true">
//       {avatar}
//     </span>
//   );
//   const userLabel =
//     drawerOpen && (children || !onLogout) ? (
//       <span className="rvt-header-id__user rvt-header-id__user--has-dropdown">
//         {username}
//       </span>
//     ) : (
...
//     logout = (
//       <a href="#0" onClick={onLogout}>
//         {logoutLinkText}
//       </a>
//     );
//   } else if (!children && onLogout) {
//     logout = (
//       <a href="#0" className="rvt-header-id__log-out" onClick={onLogout}>
//         {logoutLinkText}
//       </a>
//     );
//   }
