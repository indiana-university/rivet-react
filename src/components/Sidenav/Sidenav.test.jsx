...
describe("<SidenavMenu />", () => {
    ...
    it("should render without throwing an error", () => {
      render(
        <Sidenav.Menu
          ...
          url={itemLink}
        >
          <Sidenav.Item testMode url="#">Link 1</Sidenav.Item>
          <Sidenav.Item testMode url="#">Link 2</Sidenav.Item>
          <Sidenav.Item testMode url="#">Link 3</Sidenav.Item>
        </Sidenav.Menu>
      );
  ...
  describe("Action", () => {
    it("Clicking the toggle button should open and close the menu", () => {
      ...
      expect(button.children[0].innerHTML).toBe(`Show links nested under ${itemLabel}`)
      ...
      expect(button.children[0].innerHTML).toBe(`Hide links nested under ${itemLabel}`)
...
const checkRenderSidenavContainer = () => {
  ...
  expect(element).toHaveAttribute("aria-labelledby", `${sideNavId}-sidenav-label`)
