...
export default class Footer extends Component {
    render() {
        ...
        return <footer className="rvt-footer" role="contentinfo">
            <div className="rvt-footer__copyright-lockup">
                ...
                <p><a href="https://www.iu.edu/copyright/index.html">Copyright</a> &copy; {date} The Trustees of <a href="https://www.iu.edu/">Indiana University</a></p>
            </div>
            <ul className="rvt-footer__aux-links">
                <li className="rvt-footer__aux-item">
                    <a href={this.props.privacyPolicy ? this.props.privacyPolicy : "#"}>Privacy Policy</a>
                </li>
                <li className="rvt-footer__aux-item">
